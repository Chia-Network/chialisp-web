...
This tutorial is for users of Linux and MacOS. The equivalent Windows tutorial can be found [here](https://www.chialisp.com/docs/cats/CAT_Launch_Process_Windows "Chia Asset Token tutorial for Windows users").
