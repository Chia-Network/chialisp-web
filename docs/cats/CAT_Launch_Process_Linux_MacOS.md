...
This tutorial is for users of Linux and MacOS. The equivalent Windows tutorial can be found [here](https://www.chialisp.com/XXXX "Chia Asset Token tutorial for Windows users").
